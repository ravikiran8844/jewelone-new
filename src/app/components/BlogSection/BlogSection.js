      ...
      <div className="container">
        <div className="row">
          <div className="col-12 text-center mb-5">
            ...
            <Link className="btn btn-outline-dark blog-section_btn" href="/blog">View all</Link>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-12 col-lg-6 mb-4 d-flex justify-content-center">
              <div className="position-relative">
                <Image className="img-fluid" width="585" height="339" src="/blog-img1.webp" alt="" />
                <div className="position-absolute bottom-0 p-4 text-white">
                  <div className="date mb-3">August 2, 2023</div>
                  <div className="blog-title mb-3 w-75">How to Style Minimalist Jewellery for Any Occasion</div>
                  <Link className="blog-link" href="/blog-post">SHOP GIFTS <span className="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="10" viewBox="0 0 19 10" fill="none">
