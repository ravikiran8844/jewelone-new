...
const Footer = () => {
  ...
  return (
    <div className="wrapper custom_footer py-3" id="wrapper-footer-colophon">
    <div className="container-lg">
      <div className="row g-4 mb-4 py-4">
        ...
        <div className="col-12 col-sm-6 col-md">
          ...
          <ul className="list-unstyled">
                  ...
                  <li className="custom_footer--link-item "><span className="me-2"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.7 16.4002C22.7 17.7002 21.6 18.8002 20.3 18.8002H6.09999L1.29999 23.6002V4.6002C1.29999 3.3002 2.39999 2.2002 3.69999 2.2002H20.4C21.7 2.2002 22.8 3.3002 22.8 4.6002V16.4002H22.7Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
                    </span>Chat with Us</li>
                  <li className="custom_footer--link-item "><span className="me-2"><svg width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M26 20.1998V23.7998C26 25.0998 24.9 26.1998 23.6 26.1998C23.5 26.1998 23.4 26.1998 23.4 26.1998C19.7 25.7998 16.1 24.4998 13 22.4998C10.1 20.6998 7.6 18.1998 5.8 15.2998C3.7 12.1998 2.4 8.5998 2 4.8998C1.9 3.4998 2.9 2.3998 4.2 2.2998C4.3 2.2998 4.3 2.2998 4.4 2.2998H8C9.2 2.2998 10.2 3.1998 10.4 4.3998C10.6 5.5998 10.8 6.6998 11.2 7.7998C11.5 8.6998 11.3 9.6998 10.7 10.2998L9.2 11.7998C10.9 14.7998 13.4 17.2998 16.4 18.9998L17.9 17.4998C18.6 16.7998 19.6 16.5998 20.4 16.9998C21.5 17.3998 22.6 17.6998 23.8 17.7998C25.1 17.8998 26 18.9998 26 20.1998Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"></path>
                  </svg>

                    </span>1800 1033916</li>
                  <li className="custom_footer--link-item "><span className="me-2"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_39_1036)">
                    <path d="M25.999 5.00098H1.99902C1.72288 5.00098 1.49902 5.22483 1.49902 5.50098V22.501C1.49902 22.7771 1.72288 23.001 1.99902 23.001H25.999C26.2752 23.001 26.499 22.7771 26.499 22.501V5.50098C26.499 5.22483 26.2752 5.00098 25.999 5.00098Z" stroke="white"></path>
                    <path d="M26.246 5.24902L14.334 18.03C14.2931 18.074 14.2436 18.1091 14.1886 18.1331C14.1335 18.157 14.0741 18.1694 14.014 18.1694C13.954 18.1694 13.8946 18.157 13.8395 18.1331C13.7845 18.1091 13.7349 18.074 13.694 18.03L1.75104 5.24902" stroke="white"></path>
                    </g>
                    <defs>
                    <clipPath id="clip0_39_1036">
                    <rect width="27.999" height="27.999" fill="white"></rect>
                    </clipPath>
                    </defs>
                    </svg>
      ...
      <div className="row mb-3">
          ...
          <div className="custom_footer--bold-text mb-3">Swarna Shakti App Download</div>
          <div className="d-flex gap-2">
          <div>
              <a target="_blank" href="https://apps.apple.com/id/app/jewelone/id1507128724">
                <Image className="img-fluid" width="180" height="60" src="/app-store.png" alt=""/></a>
            </div>
            <div>
              <a target="_blank" href="https://play.google.com/store/apps/details?id=com.jewelone.winchit">
              <Image className="img-fluid" width="180" height="60" src="/g-play.png" alt="" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-6 mb-4">
          <div className="custom_footer--bold-text mb-3">We Accept</div>
          <div>
            <Image width={678} height={96} className="img-fluid" src="/payment-methods.webp" alt=""/>
          </div>

        </div>
      </div>
      <div className="row">
        <div className="col-12 footer-copy_wrapper">
          <div className="custom_footer--copy-text">© {currentYear} JewelOne. All Rights Reserved.</div>
        </div>
      </div>
    </div>
